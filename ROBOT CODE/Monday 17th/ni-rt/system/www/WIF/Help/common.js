...
document.writeln("<scr"+"ipt src=\"ms-its:glang.chm::/lvversion.js\"></"+"script>");
document.writeln("<script src='objectnames.js' type='text/javascript'></script>");
...
document.writeln("<script src='launchhelp.js' type='text/javascript'></script>");
document.writeln("<script src='linking.js' type='text/javascript'></script>");
