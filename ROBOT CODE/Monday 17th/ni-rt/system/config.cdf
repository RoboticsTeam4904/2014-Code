...
<SOFTPKG NAME="{08C44C56-99A9-43E1-B37D-7994CE71CFE3}" VERSION="4.0.0" TYPE="VISIBLE">
	...
	<IMPLEMENTATION>
		<PROCESSOR VALUE="7527"/>
		<PROCESSOR VALUE="75C7"/>
		<OS VALUE="VxWorks-PPC603"/>
...
<SOFTPKG NAME="{BE793622-69E8-4F0F-B3AB-DB06517FF276}" VERSION="13.0" TYPE="VISIBLE">
	...
	<IMPLEMENTATION>
		<PROCESSOR VALUE="7527"/>
		<PROCESSOR VALUE="758B"/>
		<PROCESSOR VALUE="75C8"/>
		<PROCESSOR VALUE="75C7"/>
		<OS VALUE="VxWorks-PPC603"/>
		<CODEBASE FILENAME="/ni-rt/system/uixml/sysconfig/nirio.SoftSwitch.binding.xml"/>
		<CODEBASE FILENAME="/ni-rt/system/uixml/sysconfig/nirio.SoftSwitch.const.de.xml"/>
		<CODEBASE FILENAME="/ni-rt/system/uixml/sysconfig/nirio.SoftSwitch.const.fr.xml"/>
		<CODEBASE FILENAME="/ni-rt/system/uixml/sysconfig/nirio.SoftSwitch.const.ja.xml"/>
		<CODEBASE FILENAME="/ni-rt/system/uixml/sysconfig/nirio.SoftSwitch.const.ko.xml"/>
		<CODEBASE FILENAME="/ni-rt/system/uixml/sysconfig/nirio.SoftSwitch.const.xml"/>
		<CODEBASE FILENAME="/ni-rt/system/uixml/sysconfig/nirio.SoftSwitch.const.zh-CN.xml"/>
		<CODEBASE FILENAME="/ni-rt/system/uixml/sysconfig/nirio.SoftSwitch.def.xml"/>
		...
		<CODEBASE FILENAME="/ni-rt/system/niriompc5125k.out"/>
		<CODEBASE FILENAME="/ni-rt/system/dnf/niriompc5125k.dnf"/>
		<CODEBASE FILENAME="/ni-rt/system/rtdmRoot/niriompc5125"/>
		<DEPENDENCY>
			<SOFTPKG NAME="{56032245-0F4B-4641-9D74-33D067EB32B3}" VERSION="12.0.0">
				<TITLE>NI-RIO</TITLE>
			</SOFTPKG>
		</DEPENDENCY>
		<DEPENDENCY>
...
[MODULE VERSIONS]
criosd.out=6.3
niriompc5125k.out=6.3

[DEPENDENCIES]
criosd.out=niriosrv.out;
niriompc5125k.out=niriosrv.out;
...
<SOFTPKG NAME="{0D328313-47CD-48C8-9A83-0CCCD96D2919}" VERSION="13.0" TYPE="HIDDEN">
	...
	<IMPLEMENTATION>
		<PROCESSOR VALUE="7527"/>
		<PROCESSOR VALUE="75C7"/>
		<CODEBASE FILENAME="/ni-rt/system/www/WIF/90BR.png"/>
		<MERGEINI TARGET="/ni-rt.ini">[MDNSRESPONDER]
ImgPath=/WIF/90BR.png
...
<SOFTPKG NAME="{899452D2-C085-430B-B76D-7FDB33BB324A}" VERSION="13.0.0" TYPE="VISIBLE" OLDESTCOMPATIBLEVERSION="8.5">
	...
	<IMPLEMENTATION>
		...
		<FEATURE SELECT="TARGET">
			<SOFTPKG NAME="{4D706F57-FD55-445B-9FB9-840F9F38274B}" VERSION="13.0">
